...
# VẼ ĐƯỜNG ĐI 3D
# =============================
def plot_path_3d(coords, path, title="Best path", save_path=None):  #thêm save_path
...
# =============================
# CHẠY PSO TRÊN TOÀN BỘ FILE TRONG THƯ MỤC
# =============================
if __name__ == "__main__":
    input_dir = "D:/Year 4/tiến hóa/project/UWSN_greedy/output_data_kmeans/"   
    output_dir = "D:/Year 4/tiến hóa/project/UWSN_greedy/output_path/output_PSO/"          
    ...
    for file in json_files:                                                     
        ...
        print(f"Đã đọc {len(coords)} cụm từ {file}")

        # Chạy PSO cho từng file
        best_path, best_time = multi_pso_tsp(coords, v_f=1, v_AUV=2.0,
                                             n_particles=30, max_iter=200)

        print(f"\nFinal best path for {file}: {best_path}")
